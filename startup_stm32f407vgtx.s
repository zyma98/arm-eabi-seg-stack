/**
  * The file is modified to support segmented stack (-fsplit-stack) on ARM EABI.
  *
  ******************************************************************************
...
/* Point r9 to the extended static base.
   The layout is described in morestack.S. */
  ldr r9, =_sdata

/* Set the stacklet boundary as the end of SRAM region,
   so that when we enter main we will switch to segmented
   stack. The SRAM layout is describted in malloc.c. */
  ldr r1, =0x20020000
  str r1, [r9, #-8]

/* Set the temp stack pointer. */
  ldr r2, =0x20008000
  str r2, [r9, #-12]

/* Call the application's entry point.
   From now we switch from boot stack to segmented stack.
   The boot stack _estack is defined in linkerscript.ld. */
  bl main
